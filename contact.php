    ...
    <section class="contact_area section_gap">
        <div class="container">
            ...
            if(isset($_GET['status']) && $_GET['status'] == "success"){
                echo "<p style='color:green; font-weight:bold; margin-top:20px;'>Thank you for your message!</p>";
            }
            if(isset($_GET['status']) && $_GET['status'] == "error"){
                echo "<p style='color:red; font-weight:bold; margin-top:20px;'>Something went wrong. Please try again.</p>";
            }
            ?>
            ...
            <<div class="row"> 
                <div class="col-md-3"> 
                    <div class="contact_info"> 
                        <div class="info_item"> 
                            <i class="lnr lnr-home"></i> <h6>California, United States</h6> 
                        ...
                        <div class="info_item"> 
                            ...
                            <h6><a href="#">support@colorlib.com</a></h6> <p>Send us your query anytime!</p> 
               </div> 
           </div> 
        </div>
